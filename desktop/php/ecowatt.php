...
?>
        ...
        <?php
if (count($eqLogics) == 0) {
	echo "<br/><br/><br/><center><span style='color:#767676;font-size:1.2em;font-weight: bold;'>{{Vous n'avez pas encore de ecowatt, cliquez sur Ajouter un ecowatt pour commencer}}</span></center>";
} else {
	?>
...
?>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{EcoWatt paramètre 1}}</label>
                    <div class="col-sm-3">
